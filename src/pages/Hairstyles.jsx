...
const Hairstyle = () => {
  ...
  return (
    <div className="bg-[#FCF9F7] min-h-screen">
      <main className="max-w-[1440px] mx-auto pt-32 pb-24 px-4 md:px-12 overflow-hidden">
        ...
        <header className="max-w-4xl mx-auto text-center mb-20 opacity-0 animate-fade-in-up">
          ...
          <h1 className="text-gray-900 text-5xl md:text-7xl font-serif font-bold leading-tight mb-6">
            Mẫu Làm{" "}
            <span className="italic font-light text-[#7F170E]">Tóc</span>
          </h1>
        ...
        <section className="mt-24 text-center border-t border-gray-200/60 pt-16 opacity-0 animate-fade-in-up delay-500">
          ...
          <Link
            to="/dat-lich"
            className="px-10 py-4 bg-[#7F170E] text-white text-[10px] uppercase tracking-[0.3em] hover:bg-[#2D1B1B] transition-all duration-300 rounded-full shadow-lg hover:shadow-xl active:scale-95"
          >
