...
const ContactHero = () => {
  ...
  return (
    <div
      // Add mt-12 right here to push the whole card down 👇
      className="mt-12 relative w-full min-h-[70vh] flex items-center justify-center overflow-hidden bg-[#FCF9F7] rounded-[2.5rem] mb-16 shadow-lg shadow-[#7F170E]/5 border border-gray-100"
      ...
      <div className="relative z-20 text-center px-6 md:px-20 py-20 w-full">
        ...
        <h1 className="relative inline-block mb-12">
          <span className="block text-gray-950 text-7xl md:text-[12rem] font-serif font-bold leading-none tracking-tighter">
            Liên{" "}
            <span className="italic font-light text-[#7F170E] -ml-4 md:-ml-10">
              Hệ
            </span>
          </span>
