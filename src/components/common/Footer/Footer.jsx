            ...
            <div className="max-w-7xl mx-auto px-6 py-12 lg:py-16">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-x-12 gap-y-10">
                    ...
                    <div className="footer-section">
                        ...
                        <p className="text-gray-400 text-[13px] leading-[1.8] tracking-wide mb-6 italic font-light">
                    ...
                    <div className="footer-section">
                        ...
                        <div className="space-y-4 text-[13px]">
                            ...
                            <div className="flex items-center space-x-3">
                                ...
                                <p className="text-gray-400">070-9150-0677</p>
                            </div>
                            <div className="flex items-center space-x-3">
                                <FaEnvelope className="text-[#7F170E] shrink-0" />
                                <p className="text-gray-400 lowercase tracking-wider">kyokimono.gc@gmail.com</p>
                            </div>
                        </div>
                    </div>
                ...
                <div className="mt-16 pt-8 border-t border-white/5 flex flex-col md:flex-row justify-between items-center text-[9px] text-gray-500 uppercase tracking-[0.3em]">
