...
const FinalCTA = () => {
  return (
    <section
      id="final-cta"
      className="relative py-32 overflow-hidden bg-[#2D1B1B]"
    >
      ...
      <div className="max-w-4xl mx-auto px-6 relative z-10 text-center">
        ...
        <h2 className="text-white text-4xl md:text-6xl font-serif font-bold leading-tight mb-8">
          ...
          <span className="italic text-[#F8D7D9]">nàng thơ</span> giữa lòng
          Kyoto?
        </h2>

        <p className="text-white/70 text-lg leading-relaxed mb-12 max-w-2xl mx-auto">
          Đừng chỉ ghé thăm Kyoto, hãy trở thành một phần của nó. Những bộ
          Kimono đẹp nhất và đội ngũ chuyên gia của chúng tôi đã sẵn sàng chờ
          đón bạn.
        </p>
        ...
        <div className="mt-20 pt-10 border-t border-white/10 grid grid-cols-2 md:grid-cols-4 gap-8">
          <div>
            <p className="text-[#F8D7D9] font-serif italic mb-1 text-sm">
              Địa chỉ
            </p>
